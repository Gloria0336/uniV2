...
export const Intro: React.FC<IntroProps> = ({ onStart, isLoading }) => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 bg-void-black text-white font-sans overflow-y-auto">
                ...
                {activeTab === 'AUTH' && (
                    <div className="space-y-6 animate-fade-in">
                        ...
                        {provider === 'GEMINI' ? (
                            ...
                            <div className="space-y-4 bg-white/5 border border-neon-blue/20 p-6 rounded">
                                <div>
                                    <label className="block text-[10px] text-neon-blue mb-1">OPENROUTER_KEY</label>
                        ...
                        <div>
                            ...
                            <div className="space-y-3">
                                {FACTIONS.map(faction => (
                                    <button key={faction.id} onClick={() => setSelectedFaction(faction.id)} className={`w-full text-left p-6 border-2 transition-all relative ${selectedFaction === faction.id ? faction.colorTheme : 'border-white/10 bg-white/5 opacity-60'}`}>
